...
python -m specbridge.eval.candidates     --mgf /cluster/tufts/liulab/yiwan01/SpecBridge/data/MassSpecGym.mgf     --dreams-ckpt /cluster/tufts/liulab/yiwan01/SpecBridge/data/ssl_model.ckpt     --adapter-ckpt /cluster/tufts/liulab/yiwan01/SpecBridge/runs/specbridge_align_chemberta_pub_v3g_ablation_finetune/ckpt_000200.pt    --candidates /cluster/tufts/liulab/yiwan01/massspecgym/cand_dict_large_form.pkl --fold-query test --use-mapped --deterministic-map --no-gaussian     --batch-size 32     --cond-dim 2048 --mapper-hidden 2048     --mol-space chemberta --chemberta-model Derify/ChemBERTa_augmented_pubchem_13m --compute-mces
